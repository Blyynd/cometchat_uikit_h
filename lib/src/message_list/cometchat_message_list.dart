...
class _CometChatMessageListState extends State<CometChatMessageList> {
    ...
    return GetBuilder(
      ...
      builder: (CometChatMessageListController value) {
        ...
        if (value.hasError == true) {
          ...
          return _getNoMessagesIndicator(context, theme);
        } else {
          return Stack(
            children: [
              Column(
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              mainAxisSize: MainAxisSize.min,
              children: [
                if (widget.hideTimestamp != true && (widget.timestampAlignment == TimeAlignment.bottom
                         ||
                    showTime))
                  getTime(theme, message,
                      dateStyle: DateStyle(
  ...
  Widget _getNoMessagesIndicator(BuildContext context, CometChatTheme theme) {
