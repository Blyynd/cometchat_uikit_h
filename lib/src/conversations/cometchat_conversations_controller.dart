...
class CometChatConversationsController
  ...
  void ccUserBlocked(User user) {
    if(conversationsBuilderProtocol.requestBuilder.includeBlockedUsers==true){
      return;
    }
...
// Check settings for Group Actions
  ...
  bool checkMessageIsAllowed(BaseMessage message) {
    return conversationsBuilderProtocol.requestBuilder.conversationType==null || message.receiverType == conversationsBuilderProtocol.requestBuilder.conversationType;
  }
