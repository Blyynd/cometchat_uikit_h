  ...
  Widget getDefaultItem(
    ...
    StatusIndicatorUtils statusIndicatorUtils =
        StatusIndicatorUtils.getStatusIndicatorFromParams(
            ...
            disableUsersPresence: controller.hideUserPresence(conversationWithUser));
    ...
    return GestureDetector(
      ...
      child: CometChatListItem(
        ...
        style: ListItemStyle(
          ...
          separatorColor: listItemStyle?.separatorColor ?? conversationsStyle.separatorColor,
        ...
        Row(
          ...
          children: [
            getReceiptIcon(theme,
                conversation: conversation,
                hideReceipt:
                    controller.getHideReceipt(conversation, hideReceipt ?? disableReceipt)),
